...
PRODUCT_COPY_FILES += device/eastaeon/$(MTK_TARGET_PROJECT)/init.project.rc:root/init.project.rc

# overlay has priorities. high <-> low.
DEVICE_PACKAGE_OVERLAYS += device/eastaeon/$(MTK_TARGET_PROJECT)/overlay
...
# PRODUCT_COPY_FILES += device/eastaeon/aeon6797_6m_n/egl.cfg:$(TARGET_COPY_OUT_VENDOR)/lib/egl/egl.cfg:mtk
# PRODUCT_COPY_FILES += device/eastaeon/aeon6797_6m_n/ueventd.mt6797.rc:root/ueventd.mt6797.rc

PRODUCT_COPY_FILES += device/eastaeon/aeon6797_6m_n/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/eastaeon/aeon6797_6m_n/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/eastaeon/aeon6797_6m_n/meta_init.project.rc:root/meta_init.project.rc

ifeq ($(MTK_SMARTBOOK_SUPPORT),yes)
PRODUCT_COPY_FILES += device/eastaeon/aeon6797_6m_n/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl:mtk \
                      device/eastaeon/aeon6797_6m_n/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm:mtk
endif

# Add FlashTool needed files
#PRODUCT_COPY_FILES += device/eastaeon/$(MTK_TARGET_PROJECT)/EBR1:EBR1
#ifneq ($(wildcard device/eastaeon/$(MTK_TARGET_PROJECT)/EBR2),)
#  PRODUCT_COPY_FILES += device/eastaeon/$(MTK_TARGET_PROJECT)/EBR2:EBR2
#endif
#PRODUCT_COPY_FILES += device/eastaeon/$(MTK_TARGET_PROJECT)/MBR:MBR
#PRODUCT_COPY_FILES += device/eastaeon/$(MTK_TARGET_PROJECT)/MT6797_Android_scatter.txt:MT6797_Android_scatter.txt
...
PRODUCT_COPY_FILES += device/eastaeon/aeon6797_6m_n/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/aeon6797_6m_n/factory/res/sound/testpattern1.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/testpattern1.wav:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/aeon6797_6m_n/factory/res/sound/ringtone.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/ringtone.wav:mtk

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6797/ACCDET.kl:system/usr/keylayout/ACCDET.kl:mtk
PRODUCT_COPY_FILES += device/eastaeon/aeon6797_6m_n/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl:mtk

# Microphone
PRODUCT_COPY_FILES += device/eastaeon/aeon6797_6m_n/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/eastaeon/aeon6797_6m_n/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/eastaeon/aeon6797_6m_n/audio_policy.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy.conf:mtk


#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/aeon6797_6m_n/factory/res/images/lcd_test_00.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_00.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/aeon6797_6m_n/factory/res/images/lcd_test_01.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_01.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/aeon6797_6m_n/factory/res/images/lcd_test_02.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_02.png:mtk
...
DEVICE_PACKAGE_OVERLAYS += device/eastaeon/aeon6797_6m_n/overlay
...
$(call inherit-product-if-exists, vendor/eastaeon/libs/$(MTK_TARGET_PROJECT)/device-vendor.mk)
...
$(call inherit-product, vendor/eastaeon/products/dyu.mk)

PRODUCT_COPY_FILES += vendor/eastaeon/touch/aeon_nt36xxx/novatek_ts_fw.bin:system/etc/firmware/novatek_ts_fw.bin
