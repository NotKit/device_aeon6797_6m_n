...
$(call inherit-product, device/eastaeon/$(MTK_TARGET_PROJECT)/device.mk)
...
ifneq (,$(filter OP01%, $(OPTR_SPEC_SEG_DEF)))
  ...
  PRODUCT_LOCALES := en_GB en_US zh_CN zh_TW es_ES pt_BR ru_RU fr_FR de_DE tr_TR vi_VN ms_MY in_ID th_TH it_IT ar_EG hi_IN bn_IN ur_PK fa_IR pt_PT nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ ko_KR km_KH iw_IL my_MM pl_PL es_US bg_BG hr_HR lv_LV lt_LT sk_SK uk_UA de_AT da_DK fi_FI nb_NO sv_SE hy_AM zh_HK et_EE ja_JP kk_KZ sr_RS sl_SI ca_ES
endif

# Set those variables here to overwrite the inherited values.
PRODUCT_MANUFACTURER := Planet
PRODUCT_NAME := full_aeon6797_6m_n
PRODUCT_DEVICE := aeon6797_6m_n
PRODUCT_MODEL := Gemini 4G
